                ...
                <div className="space-y-1 pt-1">
                  <div className="flex items-end gap-1.5">
                    <textarea
                      ...
                      className="flex-1 px-3 py-2 bg-white border border-indigo-200 rounded-xl text-xs font-medium text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 resize-y min-h-[52px] leading-relaxed"
                      disabled={analyzing}
                    />
                    <button
                      type="button"
                      ...
                      className="px-3.5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold flex items-center gap-1.5 cursor-pointer disabled:opacity-40 shadow-xs shrink-0 self-stretch justify-center"
                    >
                      {analyzing ? <RefreshCw className="w-3.5 h-3.5 animate-spin" /> : <Send className="w-3.5 h-3.5" />}
                      <span className="text-xs">조율</span>
                    </button>
                  </div>
                  <div className="flex justify-between items-center px-1 text-[10px] text-slate-400">
                    <span>💡 줄바꿈: <kbd className="px-1 py-0.5 bg-slate-100 border border-slate-200 rounded text-slate-600 font-mono">Enter</kbd></span>
                    <span>전송: <kbd className="px-1 py-0.5 bg-slate-100 border border-slate-200 rounded text-slate-600 font-mono">Ctrl+Enter</kbd> 또는 조율 버튼</span>
                  </div>
                </div>
              ) : (
