        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-slate-100">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="pt-2 space-y-1.5 border-t border-slate-100">
              ...
              <div className="flex items-center gap-1.5 text-amber-700 font-medium text-[11px] pt-0.5">
          ...
          {/* 우측 2열 (md:col-span-2): 바로가기 메뉴 및 하단 공식 SNS 채널 바로가기 */}
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {activeSnsChannels.map((sns) => (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200/80 text-slate-700 text-[11px] font-bold transition-all shadow-2xs hover:border-slate-300 hover:shadow-xs"
                    >
