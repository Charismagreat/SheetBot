                ...
                <div className="space-y-1 pt-1">
                  <div className="flex items-end gap-1.5">
                    ...
                    <button
                      ...
                      className="px-3.5 py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-bold rounded-xl flex items-center gap-1.5 transition-all cursor-pointer shadow-xs shrink-0 self-stretch justify-center"
                    >
                      {analyzing ? (
                        <RefreshCw className="w-3.5 h-3.5 animate-spin" />
                      ) : (
                  ...
                  <div className="flex justify-between items-center px-1 text-[10px] text-slate-400">
                    ...
                    <span>전송: <kbd className="px-1 py-0.5 bg-slate-100 border border-slate-200 rounded text-slate-600 font-mono">Ctrl+Enter</kbd> 또는 전송 버튼</span>
                  </div>
                </div>
              ) : (
