...
const USE_CASES: UseCase[] = [
  {
    ...
    prompt:
      "매일 오전 9시에 '재고현황' 탭에서 [현재고] 열의 수량이 [안전재고] 열보다 작은 행들을 모두 검색해줘. 부족한 품목명과 수량을 보기 좋게 정리해서 담당자 휴대폰 번호(010-XXXX-XXXX)로 SheetBot Agent2 0원 문자를 자동 발송하고, 시트 상단에 [최근알림일시]를 기록해줘.",
